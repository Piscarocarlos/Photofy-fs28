    ...
    <div class="lg:flex justify-center lg:space-x-10 lg:space-y-0 space-y-5">
        ...
        <div class="space-y-5 flex-shrink-0 lg:w-7/12">
            ...
            <div class="bg-white shadow rounded-md dark:bg-gray-900 -mx-2 lg:mx-0">
                    ...
                    <div class="flex flex-1 items-center space-x-4">
                        <a href="#">
                            <div class="bg-gradient-to-tr from-yellow-600 to-pink-600 p-0.5 rounded-full">
                                <img src="{{ $post->user->avatar }}" class="bg-gray-200 border border-white rounded-full w-8 h-8">
                            </div>
                        </a>
                        <span class="block capitalize font-semibold dark:text-gray-100"> {{ $post->user->getFullName() }} </span>
                    </div>
                  <div>
                ...
                <div uk-lightbox>
                    <a href="{{ $post->image }}">
                        <img src="{{ $post->image }}" alt="" class="img-box">
                    </a>
                </div>
        ...
        <div class="lg:w-5/12">
            ...
            @include('partials.follow', ['following_users', $following_users])
