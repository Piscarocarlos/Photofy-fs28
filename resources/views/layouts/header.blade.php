<header>
    <div class="header_inner">
        ...
        <div class="right-side lg:pr-4">
                    ...
                    <form action="{{ route('posts.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="flex flex-col choose-upload text-center">
                            ...
                            <a href="#" class="uk-text-muted mt-3 uk-link"
                                ...
                                Or Import Video </a>
                            <button type="submit" class="button soft-warning small mt-3"> Pusblish</button>
                        </div>
                    </form>
            ...
            <a href="#" class="header-links-item notify-link">
                        ...
                        <li>
                            <a href="#">
                                <div class="drop_avatar">
                                    <img src="{{ $notify->data['user']['avatar'] }}" alt="">
                                </div>
                                <div class="drop_content">
                                    <p> {{ $notify->data['message'] }} de {{ $notify->data['user']['pseudo'] }}</p>
            ...
            <a href="#">
                <img src="{{ Auth::user()->avatar }}" class="header-avatar" alt="">
            </a>
